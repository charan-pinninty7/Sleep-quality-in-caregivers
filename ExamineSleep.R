...
##sleep quality model
load("C:/Sleep-quality-in-caregivers-master/Final models/Final feeling refreshed models.RData.RData")
...
root="C:\\Sleep-quality-in-caregivers-master/Examine_your_sleep_with_our_model\\";
numberPerson = 1
numberWeek = 1
numberDay = 9
